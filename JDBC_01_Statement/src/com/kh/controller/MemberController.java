...
public class MemberController {
	 ...
	 * @param userId 회원아이디 
	 */
	public void insertMember(String userId, String userPwd, String name, char gender) {
	...
	public void modifyById(String userId, String selectedInfo, String afterInfo) {
		int result = new MemberDao().modifyById(userId, selectedInfo, afterInfo);
	...
	public void modifyById2(String id, String userPw, String userName, String address, String phone, String hobby) {
		...
		int result = new MemberDao().modifyById2(m);
